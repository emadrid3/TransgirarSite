...
/** Crea una entrada cifrada nueva para un usuario. Devuelve el objeto listo para guardar en site-data.txt */
...
async function loadUsers() {
  const res = await fetch("./site-data.txt", { cache: "no-store" });
  if (!res.ok) return [];
